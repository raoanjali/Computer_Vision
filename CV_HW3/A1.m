...
imdb1 = load('data_batch_1.mat') ;
imdb2 = load('data_batch_2.mat') ;
imdb3 = load('data_batch_3.mat') ;
imdb4 = load('data_batch_4.mat') ;
imdb5 = load('data_batch_5.mat');
imdb = load('batches.meta.mat') ;
